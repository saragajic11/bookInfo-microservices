...
public class HealthCheckConfiguration {
    ...
    ReactiveHealthIndicator healthcheckMicroservices() {
        ...
        registry.register("book",           () -> getHealth("http://book"));
        registry.register("comment",    () -> getHealth("http://comment"));
        registry.register("book-theme-night",            () -> getHealth("http://bookthemenight"));
        registry.register("rating",            () -> getHealth("http://rating"));
        registry.register("book-composite", () -> getHealth("http://book-composite"));
